 ...
 *
 *  This variable can be set to the following values:
 *    "0" or "nearest" - Nearest uint32_t sampling
 *    "1" or "linear"  - Linear filtering (supported by OpenGL and Direct3D)
 *    "2" or "best"    - Currently this is the same as "linear"
 *
 *  By default nearest uint32_t sampling is used
 */
...
*  created SDL_Window:
*
*  1. Its uint32_t format will be set to the same uint32_t format as this SDL_Window.  This is
 ...
 *  and does not cause SDL to use a virtualized coordinate system, so it will generally give you 1 SDL coordinate = 1 uint32_t
